...
$sel = $conexion->prepare("SELECT foto_principal FROM inventario WHERE propiedad = ? ");
...
<div class="row">
	...
	<div class="col s6">
 	 ...
 	 <div class="col s6">
 	 	...
 	 	<h2 class="header">Agregar imagenes</h2>
			...
			<div class="card-content">
				...
				<?php 
					...
					while ($f_img = $res_img->fetch_assoc()) { ?>
					 ...
					 <a href="#" onclick="swal({ title: 'Estas seguro que deseas eliminar la imagen?', text: 'Al eliminarla no podra recuperarlo!', type: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor:'#d33', confirmButtonText: 'Si, eliminarlo' }).then(function () {
                  		location.href='eliminar_img.php?id=<?php echo $f_img['id'] ?>&ruta=<?php echo $f_img['ruta'] ?>&id_propiedad=<?php echo $id ?>'; })"><img width="420px" src="<?php echo $f_img['ruta'] ?>" alt=""></a>
