...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($user == null && $pass == null) {
		...
		$sel = $conexion->query("SELECT * FROM usuario WHERE nick='$usuario' AND pass='$pass2'AND bloqueo=1 ");
		...
		if ($row == 1) {
			...
			header('location:../extend/alerta.php?msj=Nombre de usuario o contrasena incorrectas&c=salir&p=salir&t=error');
		}
	}
