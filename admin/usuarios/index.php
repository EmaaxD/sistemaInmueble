			...
			<div class="card-content">
				...
				<form class="form" action="ins_usuarios.php" method="post" enctype="multipart/form-data">
					...
					<select name="nivel" required>
						...
						<option value="" disabled selected>ELIGI UN NIVEL DE USUARIO</option>
					...
					<thead>
						...
						<?php while ($f = $sel->fetch_assoc()) { ?>
							...
							<tr>
								...
								<td><img src="<?php echo $f['foto'] ?>" alt="" width="50" class="circle"></td>
								<td>
								...
								<td>
									<a href="#" class="btn-floating red" onclick="swal({ title: 'Estas seguro que deseas eliminar al cliente?', text: 'Al eliminarlo no podra recuperarlo!', type: 'warning', showCancelButton: true, confirmButtonColor: '#3085d6', cancelButtonColor:'#d33', confirmButtonText: 'Si, eliiminarlo' }).then(function () {
